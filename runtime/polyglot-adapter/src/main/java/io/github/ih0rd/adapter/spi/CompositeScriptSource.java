...
/**
 * {@link ScriptSource} implementation that delegates resolution to multiple underlying sources.
 *
 * <p>Sources are evaluated in order, and the first source reporting that a script exists is used to
 * open it.
 *
 * <p>This is useful for layered override chains such as in-memory overrides followed by filesystem
 * fallbacks and finally classpath defaults.
 */
